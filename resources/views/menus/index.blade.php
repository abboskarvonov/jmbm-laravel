                        ...
                        <table class="min-w-full divide-y divide-neutral-300">
                            <thead class="bg-neutral-50 dark:bg-neutral-800">
                                <tr class="text-gray-900 dark:text-gray-100">
                                    ...
                                    <th class="px-5 py-3 font-semibold uppercase">Slug</th>
                            ...
                            <tbody class="divide-y divide-neutral-200 bg-gray-50 dark:bg-gray-700">
                                @foreach ($menus as $menu)
                                    <tr class="text-neutral-800 text-center dark:text-neutral-200">
                                        ...
                                        <td class="px-5 py-4 whitespace-nowrap">{{ $menu->name_uz }}</td>
                                        <td class="px-5 py-4 whitespace-nowrap">{{ $menu->slug }}
                                        </td>
                                        <td
                                            ...
                                            <a class="text-gray-600 dark:text-gray-300 hover:text-gray-700"
                                                href="{{ route('menus.show', ['menu' => $menu->id]) }}"><i
                                                    class="fa fa-eye"></i></a>
                                            <a class="text-indigo-600 hover:text-indigo-700"
                                                href="{{ route('menus.edit', ['menu' => $menu->id]) }}"><i
